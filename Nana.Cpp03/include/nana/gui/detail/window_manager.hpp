...
namespace detail
{
	...
	public:
		...
		{
			return (wd && (wd->other.category == static_cast<gui::category::flags::t>(category::root_tag::value)));
		}
		...
		core_window_t* create_root(core_window_t* owner, bool nested, rectangle r, const appearance& app)
		{
			...
			if(owner)
			{
				...
				{
					ownerWnd = (owner->other.category == static_cast<gui::category::flags::t>(category::frame_tag::value) ?
