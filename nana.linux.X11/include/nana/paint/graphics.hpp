...
namespace nana
{
	namespace paint
	{
		...
		public:
			...
			int  string(int x, int y, color_t, const nana::string&, unsigned pixels, bool omitted, nana::size& ts);
			void string(int x, int y, color_t, const nana::string&, unsigned pixels, size_t lines);
